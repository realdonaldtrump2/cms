...
$moduleControllerAction = explode('/', $model->name);
$model->module = $moduleControllerAction[0];
$model->controller = $moduleControllerAction[1];
$model->action = $moduleControllerAction[2];

...
<div class="function-button-container">
    ...
    <?php if (Yii::$app->user->can('backend/rbac/permission-create')): ?>
        <?= Html::a('<i class="fa fa-plus" ></i> 创建权限', ['permission-create'], ['class' => 'btn btn-primary']) ?>
    <?php else: ?>
    <?php endif; ?>
...
<?php echo $this->render('_search-permission-index', ['model' => $searchModel]); ?>
        ...
        [
            ...
            'buttons' => [
                'update' => function ($url, $model, $key) {
                    if (Yii::$app->user->can('backend/rbac/permission-update')) {
                        return Html::a('编辑', ['permission-update', 'name' => $model->name], ['class' => 'btn btn-outline btn-xs btn-primary']);
                    }
                },
            ]
        ],

...
/* @var $searchModel backend\models\ArticleTagSearch */
...
<div class="function-button-container">
    ...
    <?php if (Yii::$app->user->can('backend/article-tag/create')): ?>
        <?= Html::a('<i class="fa fa-plus" ></i> 文章标签创建', ['create'], ['class' => 'btn btn-primary']) ?>
    <?php else: ?>
    <?php endif; ?>
            ...
            'buttons' => [
                ...
                'delete' => function ($url, $model, $key) {
                    if (Yii::$app->user->can('backend/article-tag/delete')) {
                        ...
                        return Html::a('删除', ['article-tag/delete', 'id' => $model->id], $options);
                    }
                }
            ]
        ],

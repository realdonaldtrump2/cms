...
function init_sidebar() {
    var setContentHeight = function () {
        ...
        var bodyHeight = $BODY.outerHeight(), footerHeight = $BODY.hasClass("footer_fixed") ? -10 : $FOOTER.height(),
...
function init_flot_chart() {
    ...
    var chart_plot_02_settings = {
        ...
        series: {
            lines: {show: true, fill: true, lineWidth: 2, steps: false},
            points: {show: true, radius: 4.5, symbol: "circle", lineWidth: 3}
        },
        legend: {
            position: "ne",
            margin: [0, -25],
        ...
        shadowSize: 0,
        tooltip: true,
        tooltipOpts: {content: "%s: %y.0", xDateFormat: "%d/%m", shifts: {x: -30, y: -50}, defaultTheme: false},
        yaxis: {min: 0},
        xaxis: {
            mode: "time",
            minTickSize: [1, "day"],
...
function init_chart_doughnut() {
    ...
    if ($(".canvasDoughnut").length) {
        var chart_doughnut_settings = {
            ...
            options: {legend: false, responsive: false}
        };
...
function init_wysiwyg() {
    ...
    $(".editor-wrapper").each(function () {
        var id = $(this).attr("id");
        $(this).wysiwyg({toolbarSelector: '[data-target="#' + id + '"]', fileUploadError: showErrorAlert})
    });
    window.prettyPrint;
    prettyPrint()
}
...
function init_IonRangeSlider() {
    ...
    $("#range_26").ionRangeSlider({type: "double", min: 0, max: 10000, step: 500, grid: true, grid_snap: true});
    $("#range_31").ionRangeSlider({type: "double", min: 0, max: 100, from: 30, to: 70, from_fixed: true});
    ...
    CustomTabs = function (options) {
        ...
        $(".notifications a").click(function (e) {
            ...
            var $this = $(this),
                ...
                others = $this.closest("li").siblings().children("a"), target = $this.attr("href");
...
function init_charts() {
    ...
    if ($("#canvasRadar").length) {
        ...
        var canvasRadar = new Chart(ctx, {type: "radar", data: data,})
    }
    if ($("#pieChart").length) {
    ...
    if ($("#polarArea").length) {
        ...
        var polarArea = new Chart(ctx, {data: data, type: "polarArea", options: {scale: {ticks: {beginAtZero: true}}}})
    }
}
    ...
    var calendar = $("#calendar").fullCalendar({
        ...
        select: function (start, end, allDay) {
            ...
            $(".antosubmit").on("click", function () {
                ...
                if (title) {
                    calendar.fullCalendar("renderEvent", {title: title, start: started, end: end, allDay: allDay}, true)
                }
                $("#title").val("");
...
function init_DataTables() {
    ...
    $datatable.dataTable({"order": [[1, "asc"]], "columnDefs": [{orderable: false, targets: [0]}]});
...
function init_morris_charts() {
    ...
    if ($("#graph_donut").length) {
        Morris.Donut({
            element: "graph_donut",
            data: [{label: "Jam", value: 25}, {label: "Frosted", value: 40}, {
                label: "Custard",
                value: 25
...
function init_echarts() {
    ...
    if ($("#echart_sonar").length) {
        ...
        echartRadar.setOption({
            ...
            toolbox: {
                show: true,
                feature: {restore: {show: true, title: "Restore"}, saveAsImage: {show: true, title: "Save Image"}}
            },
            polar: [{
                indicator: [{text: "Sales", max: 6000}, {
                    text: "Administration",
                    max: 16000
                }, {text: "Information Techology", max: 30000}, {
                    text: "Customer Support",
                    max: 38000
                }, {text: "Development", max: 52000}, {text: "Marketing", max: 25000}]
            }],
            calculable: true,
            series: [{
    ...
    if ($("#echart_gauge").length) {
        ...
        echartGauge.setOption({
            ...
            series: [{
                ...
                title: {show: true, offsetCenter: ["-65%", -10], textStyle: {color: "#333", fontSize: 15}},
                detail: {
                    show: true,
        ...
        echartLine.setOption({
            ...
            toolbox: {
                ...
                feature: {
                    ...
                    }, restore: {show: true, title: "Restore"}, saveAsImage: {show: true, title: "Save Image"}
                }
            },
            calculable: true,
    ...
    if ($("#echart_scatter").length) {
        ...
        echartScatter.setOption({
            ...
            toolbox: {show: true, feature: {saveAsImage: {show: true, title: "Save Image"}}},
    ...
    if ($("#echart_mini_pie").length) {
        ...
        echartMiniPie.setOption({
            ...
            series: [{
                ...
                radius: [105, 130],
                itemStyle: dataStyle,
                data: [{value: 68, name: "68%Something #1"}, {
                    value: 32,
                    name: "invisible",
                ...
                radius: [80, 105],
                itemStyle: dataStyle,
                data: [{value: 29, name: "29%Something #2"}, {
                    value: 71,
                    name: "invisible",
                    itemStyle: placeHolderStyle
                }]
                ...
                radius: [25, 80],
                itemStyle: dataStyle,
                data: [{value: 3, name: "3%Something #3"}, {value: 97, name: "invisible", itemStyle: placeHolderStyle}]
            }]
        })
    }

...
/**
 * SoftwareCategorySearch represents the model behind the search form of `common\models\SoftwareCategory`.
 */
class SoftwareCategorySearch extends SoftwareCategory
{
